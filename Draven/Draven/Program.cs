...
namespace RevampedDraven
{
    ...
    public static class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Menu.Add("useQ", new CheckBox("Kullan Q", true));
            Menu.Add("useW", new CheckBox("Kullan W", true));
            Menu.Add("useE", new CheckBox("Kullan E", true));
            Menu.Add("useR", new CheckBox("Kullan R", true));
            Menu.Add("enemyCount", new Slider("R için gereken düşman sayısı", 2, 1, 5));
            Menu.AddSeparator();
            Menu.AddGroupLabel("Harass");
            Menu.Add("useQH", new CheckBox("Kullan Q", true));
            Menu.Add("useWH", new CheckBox("Kullan W", true));
            Menu.Add("useEH", new CheckBox("Kullan E", true));
            Menu.Add("manaH", new Slider("Dürtme için en az mana", 65, 0, 100));
            Menu.AddSeparator();
            Menu.AddGroupLabel("Lane Clear");
            Menu.Add("useQLC", new CheckBox("Use Q", true));
            Menu.Add("useELC", new CheckBox("Use E", true));
            Menu.Add("manaLC", new Slider("Lane temizlik için en az mana", 90, 0, 100));
            Menu.AddSeparator();
            Menu.AddGroupLabel("Jungle Clear");
            Menu.Add("useQJG", new CheckBox("Kullan Q", true));
            Menu.Add("useEJG", new CheckBox("Kullan E", true));
            Menu.Add("manaJG", new Slider("Orman temizleme için en az mana", 65, 0, 100));
            Menu.AddSeparator();
            Menu.AddGroupLabel("Misc.");
            Menu.Add("interrupt", new CheckBox("Interrupter", true));
            Menu.Add("gapcloser", new CheckBox("Gapcloser", true));
            Menu.Add("catchaxe", new CheckBox("Baltayı otomatik yakala", true));
            Menu.Add("onlycatch", new CheckBox("Otomatik yakalamada orbwalker?", true));
            Menu.AddSeparator();
            Menu.Add("drawe", new CheckBox("Göster E", true));
            Menu.Add("drawr", new CheckBox("Göster R", true));
            Menu.Add("drawaxe", new CheckBox("Göster balta yakalama menzili", true));
            Menu.Add("drawaxedrop", new CheckBox("Göster Balta nesnesi", true));
            Menu.AddSeparator();
            Menu.Add("mine", new Slider("E için en az mana", 65, 0, 100));
            Menu.Add("catchaxerange", new Slider("Balta yakalama menzili", 600, 0, 2000));
