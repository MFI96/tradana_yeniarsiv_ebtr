    ...
    public static class Config
    {
        ...
        public static class Misc
        {
            ...
            static Misc()
            {
                ...
                _drawCombo = Menu.Add("drawCombo", new CheckBox("Göster Combo Hasarı"));
                Menu.AddSeparator();
                Menu.Add("accuracyQ", new Slider("Farm yaparken Q kullan şu menzile", 50, 10, 1075));
                _activateQ = Menu.Add("activateQ", new CheckBox("Q2 otomatik aktif et"));
                Menu.AddSeparator();
                _tearStack = Menu.Add("tearStack", new CheckBox("URF modu"));
                _autolevelskills = Menu.Add("autolevelskills", new CheckBox("Otomatik level arttırma"));
                _autoBuyStartingItems = Menu.Add("autoBuyStartingItems", new CheckBox("Başlangıçta otomatik item al"));
                Menu.AddSeparator();
                _autoInterrupt = Menu.Add("autoInterrupt", new CheckBox("Autointerrupt Tehlikeli büyü kanalı"));
                _antiDash = Menu.Add("antiDash", new CheckBox("Otomatik interrupt Dürtme"));
                _antiDashOffensive = Menu.Add("antiDashOffensive", new CheckBox("Saldırı itemlerini kullan"));
                Menu.AddSeparator();
                _useSkinHack = Menu.Add("useSkinHack", new CheckBox("Skin Değiştirici Kullan"));
                _skinId = Menu.Add("skinId", new Slider("Skin Numarası", 5, 1, 7));
                Menu.AddSeparator();
                _cleanseStun = Menu.Add("cleanseStun", new CheckBox("Sabitleyici temizleme"));
                _cleanseEnemies = Menu.Add("cleanseEnemies", new Slider("Şu kadar düşman varsa temizle", 2, 0, 5));
                Menu.AddSeparator();
                _useSeraphsDmg = Menu.Add("useSeraphsDmg", new CheckBox("1000 mana itemi kullan"));
                _useSeraphsCC = Menu.Add("useSeraphsCC", new CheckBox("Tehlikeli büyülerde kullan"));
                Menu.AddSeparator();
                _useZhonyasDmg = Menu.Add("useZhonyasDmg", new CheckBox("Yüksek hasarda zhonya kullan"));
                _useZhonyasCC = Menu.Add("useZhonyasCC", new CheckBox("Tehlikeli büyülerde zhonya kullan"));
                Menu.AddSeparator();
        ...
        public static class Modes
        {
            ...
            public static class Combo
            {
                ...
                static Combo()
                {
                    ...
                    _useW = Menu.Add("comboUseW", new CheckBox("Kullan AKILLI W"));
                    ...
                    _deactiveR = Menu.Add("deactiveR", new CheckBox("Otomatik iptal Ult"));
                    _ksE = Menu.Add("ksE", new CheckBox("E ile kill çal"));
                    _ksI = Menu.Add("ksI", new CheckBox("Tutuştur ile kill çal"));
                    Menu.Add("hitChanceQ", new Slider("İsabet oranı için Q", 2, 1, 3));
                }
            ...
            public static class Harass
            {
                ...
                static Harass()
                {
                    ...
                    Menu.Add("harassUseW", new CheckBox("Kullan W (sadece düşmanı engelelyecekse)"));
                    Menu.Add("harassUseE", new CheckBox("Kullan E (Sadece çift hasar verecekse)"));
                    Menu.Add("harassUseR", new CheckBox("Kullan R", false)); // Default false
            ...
            public static class LaneClear
            {
                ...
                static LaneClear()
                {
                    ...
                    _useR = Menu.Add("clearUseR", new CheckBox("Kullan R"));
                    _deactiveR = Menu.Add("clearDeactiveR", new CheckBox("Ulti otomatik iptal"));
            ...
            public static class JungleClear
            {
                ...
                static JungleClear()
                {
                    ...
                    _useR = Menu.Add("jglUseR", new CheckBox("Kullan R"));
                    _deactiveR = Menu.Add("jglDeactiveR", new CheckBox("Ulti otomatik iptal"));
