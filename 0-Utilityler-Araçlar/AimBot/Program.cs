...
namespace AimBot
{
    internal static class Program
    {
        ...
        private static void Load()
        {
            ...
            Menu.Add("Enable", new KeyBind("Aktif / Pasif", true, KeyBind.BindTypes.PressToggle, 'K'));
            var drawings = Menu.Add("Draw", new CheckBox("Yazıyı Göster"));
            ...
            {
                Menu.AddGroupLabel(slot + " Ayarları");
                SlotsComboBox[slot] = Menu.Add(slot + "ComboBox", new ComboBox("Kullan", new List<string> { "Asla", "Komboda", "Her Zaman" }, 2));
                SlotsSlider[slot] = Menu.Add(slot + "HitChancePercent", new Slider("İsabet Oranı", 60));
            }
