...
namespace iAhri
{
    internal class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Chat.Print(AddonName + " Tarafından " + Author + " Yuklendi, İyi Eglenceler!-ceviri tradana.");
            ...
            menu = MainMenu.AddMenu(AddonName, AddonName + " by " + Author + "v1.0, ceviri tradana");
            menu.AddLabel(AddonName + " Tarafından " + Author);

            SubMenu["Combo"] = menu.AddSubMenu("Kombo", "Combo");
            ...
            SubMenu["Combo"].Add("R", new CheckBox("R Kullan", true));
            SubMenu["Combo"].Add("CatchQR", new CheckBox("Q ile yakalarsan R kullan", true));
            SubMenu["Combo"].Add("CatchQRPriority", new CheckBox("Give Priority to Catch the Q with R", true));

            SubMenu["Harass"] = menu.AddSubMenu("Dürtme", "Harass");
            ...
            SubMenu["KillSteal"] = menu.AddSubMenu("Kill Çalma", "KillSteal");
            ...
            SubMenu["Flee"] = menu.AddSubMenu("Flee(kaçma)", "Flee");
            SubMenu["Flee"].Add("Q", new CheckBox("Q Kullan", true));
            SubMenu["Flee"].Add("R", new CheckBox("R Kullan", true));

            SubMenu["Draw"] = menu.AddSubMenu("Göstergeler", "Drawing");
            SubMenu["Draw"].Add("Line", new CheckBox("Q çizgisini orbwalker'a göre çiz", true));

            SubMenu["Misc"] = menu.AddSubMenu("Ek", "Misc");
