...
namespace WuAIO
{
    class Morgana : HeroBase
    {
        ...
        public override void CreateMenu()
        {
            ...
            {
                menu.NewCheckbox("disable", "Devredışı", false);
                menu.NewCheckbox("damageindicator", "Hasar Tespitçisi");
            ...
            menu = MenuManager.AddSubMenu("Combo");
            {
                ...
                menu.NewSlider("q.hitchance%", "Q İsabet oranı%", 85, 1, 100);
                menu.NewCheckbox("w", "W Kullan");
                menu.NewCheckbox("r", "R Kullan", true);
                menu.NewSlider("r.minenemies", "R için en az düşman", 2, 1, 5);
            }
            ...
            menu = MenuManager.AddSubMenu("Harass");
            {
                ...
                menu.NewCheckbox("w.jitii", "Hedef sabitse W kullan");
                menu.NewSlider("mana%", "ena z mana%", 30, 1, 99, true);
            }

            menu = MenuManager.AddSubMenu("Lane Clear");
            {
                menu.NewCheckbox("w", "W Kullan");
                menu.NewSlider("w.minminions", "W için en az minyon", 3, 1, 7);
            ...
            {
                menu.NewCheckbox("ks", "Killçalma", false);
                menu.NewCheckbox("aaminionswhenallynear", "Dostlar ykaındayken minyona düz vuruş yap?");
                menu.NewCheckbox("autoqonimmobile", "Sabit hedefe Q at", true);
                menu.NewCheckbox("autoqonflash", "Otomatik Flash tan sonra Q kullan", true);
                menu.NewCheckbox("autoqondash", "Q ile otomatik dürt", true);
                menu.NewCheckbox("autowonimmobile", "Sabit hedefe otomatik W", true);
                menu.NewCheckbox("gapcloser", "Gapcloser için Q kullan", true);
            }
            ...
            {
                EMenu.Add(ally.BaseSkinName, new Slider(string.Format("{0}'s Önceliği", ally.BaseSkinName), 3, 1, 5));
                EMenu.AddSeparator();
            }
            ...
            EMenu.AddGroupLabel("Şunlar için kalkan kullan:");
